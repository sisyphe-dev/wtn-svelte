...
dfx nns install
dfx deploy internet_identity --mode reinstall --yes
...
export internet_identity_id="qhbym-qaaaa-aaaaa-aaafq-cai"
...
dfx deploy passcode_manager --argument "(principal \"$nicp_ledger_id\", 100000000, principal \"$swap_factory_id\", principal \"$minter_id\")"
