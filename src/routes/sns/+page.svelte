	...
	{#key $sns.name}
		<div class="boomerang-container" in:fade={{ duration: 500 }}>
			...
			<div class="step-container" in:fade={{ duration: 500 }}>
				...
				{:else}
					<button class="action-btn" title="notifyIcpDeposit-btn" on:click={notifyIcpDeposit}>Confirm SNS deposit</button>
				{/if}
			</div>
			<div class="step-container" in:fade={{ duration: 500 }}>
				<div class="instruction-container">
				...
				{:else}
					<button class="action-btn" title="retrieveNicp-btn" on:click={retrieveNicp}>Retrieve nICP</button>
				{/if}
			</div>
		</div>
	{/key}
