<svg viewBox="0 0 364 364" xmlns="http://www.w3.org/2000/svg">
	<defs>
		...
		<linearGradient
			...
			x2="974.005"
			y2="388.865"
			gradientTransform="matrix(-0.999851, -0.016909, 0.017656, -1.110698, 1932.460787, 509.602999)"
		...
		<linearGradient
			...
			x2="188.919"
			y2="361.638"
			gradientTransform="matrix(-0.465435, -0.885082, 1.172947, -0.616813, 14.606062, 499.208888)"
	...
	<path
		...
		style="fill: url(#gradient-6-0);"
		transform="matrix(-0.701584, 0.712586, -0.712586, -0.701584, 442.975678, 174.812952)"
	/>
	<path
		style="stroke-width: 0px; paint-order: stroke; fill: url(#gradient-5-1);"
