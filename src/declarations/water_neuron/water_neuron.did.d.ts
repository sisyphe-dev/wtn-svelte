...
export type GuardError = { 'AlreadyProcessing' : null } |
  { 'TooManyConcurrentRequests' : null };
...
export type LiquidArg = { 'Upgrade' : [] | [UpgradeArg] } |
  { 'Init' : InitArg };
...
export type NeuronOrigin = { 'NICPSixMonths' : null } |
  { 'SnsGovernanceEightYears' : null };
...
export type Result = { 'Ok' : MergeResponse } |
  { 'Err' : CancelWithdrawalError };
export type Result_1 = { 'Ok' : bigint } |
  { 'Err' : ConversionError };
export type Result_2 = { 'Ok' : NeuronId } |
  { 'Err' : NeuronId };
export type Result_3 = { 'Ok' : DepositSuccess } |
  { 'Err' : ConversionError };
export type Result_4 = { 'Ok' : WithdrawalSuccess } |
  { 'Err' : ConversionError };
...
export type TransferFromError = {
  ...
  { 'TooOld' : null } |
  { 'InsufficientFunds' : { 'balance' : bigint } };
export type TransferStatus = { 'Executed' : ExecutedTransfer } |
  { 'Unknown' : null } |
  { 'Pending' : PendingTransfer };
export type Unit = { 'ICP' : null } |
  { 'WTN' : null } |
  { 'NICP' : null };
export interface UpgradeArg { 'governance_fee_share_percent' : [] | [bigint] }
...
export interface _SERVICE {
  ...
  'get_transfer_statuses' : ActorMethod<
    [BigUint64Array | bigint[]],
    Array<TransferStatus>
  >,
  'get_withdrawal_requests' : ActorMethod<
    [[] | [Account]],
