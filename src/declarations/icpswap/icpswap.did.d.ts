...
export type Result_18 = {
  ...
  { 'err' : Error };
export type Result_19 = { 'ok' : Page_4 } |
  { 'err' : Error };
export type Result_2 = { 'ok' : boolean } |
  { 'err' : Error };
export type Result_20 = { 'ok' : PositionInfo } |
  { 'err' : Error };
export type Result_21 = { 'ok' : CycleInfo } |
  { 'err' : Error };
export type Result_22 = { 'ok' : { 'amount0' : bigint, 'amount1' : bigint } } |
  { 'err' : Error };
export type Result_23 = {
  ...
  { 'err' : Error };
export type Result_24 = { 'ok' : Page_5 } |
  { 'err' : Error };
